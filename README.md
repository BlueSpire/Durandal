...
All the documenttion is located in the [wiki](https://github.com/EisenbergEffect/Durandal/wiki), so have a look there for how to get setup, tutorials, sample descriptions and module reference docs.
