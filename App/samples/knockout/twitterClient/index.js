define(['durandal/system','durandal/app'], function (system,app) {
        ...
        this.selectedList = "Tech pundits";

        this.twitterApi = (function () {
        ...
        var savedLists = ko.observableArray(this.initialLists);

        var editingList = {
            name: ko.observable(this.selectedList),
        ...
        ko.computed(function () {
            this.twitterApi.getTweetsForUsers(editingList.userNames(), currentTweets);
        });
